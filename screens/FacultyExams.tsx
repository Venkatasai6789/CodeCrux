        ...
        {loading ? (
            <div className="flex items-center justify-center h-64">
                <div className="text-center">
                    ...
                    <p className="text-slate-500 text-sm">Loading your exams...</p>
                </div>
            </div>
        ) : exams.length === 0 ? (
                            ...
                            <div className="flex-1 min-w-0">
                                ...
                                <div className="flex flex-wrap items-center gap-4 text-xs text-slate-500">
                                    ...
                                    <span className="flex items-center gap-1.5">
                                        <Calendar className="w-3.5 h-3.5" /> {typeof exam.date === 'string' ? exam.date : new Date(exam.date).toLocaleDateString()}
                                    </span>
                                    <span className="flex items-center gap-1.5">
                                    ...
                                    <span className="flex items-center gap-1.5 font-medium text-indigo-600">
                                        <FileText className="w-3.5 h-3.5" /> {exam.questionCount} Questions
                                    </span>
                                </div>
                            </div>
