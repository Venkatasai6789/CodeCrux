    ...
    <div className="bg-white rounded-[2rem] p-8 border border-slate-100 shadow-sm relative overflow-hidden group hover:shadow-md transition-all duration-300">
      ...
      <div className="relative z-10 flex flex-col items-center text-center">
        ...
        <div className="flex items-center gap-3 w-full">
            <button className="flex-1 py-3.5 rounded-2xl border-2 border-slate-100 text-xs font-black text-slate-600 hover:bg-slate-50 hover:border-slate-200 transition-all uppercase tracking-widest active:scale-95">
                Redeem
            </button>
            <button className="flex-1 py-3.5 rounded-2xl bg-slate-900 text-white text-xs font-black shadow-xl shadow-slate-900/20 hover:bg-indigo-600 hover:shadow-indigo-600/20 transition-all uppercase tracking-widest active:scale-95">
                Collect
            </button>
        </div>
      </div>
